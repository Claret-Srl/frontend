...
export const demoServices: HassServices = {
  homeassistant: {
    ...
    stop: { description: "Stop the Safegate Pro service.", fields: {} },
    restart: { description: "Restart the Safegate Pro service.", fields: {} },
    check_config: {
      description:
        "Check the Safegate Pro configuration files for errors. Errors will be displayed in the Safegate Pro log.",
      fields: {},
    },
    update_entity: {
    ...
    play_media: {
      ...
      fields: {
        ...
        media_content_id: {
          ...
          example: "https://safegatepro.it/images/cast/splash.png",
        },
        media_content_type: {
          description:
